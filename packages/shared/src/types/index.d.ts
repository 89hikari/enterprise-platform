...
export type WorkHistoryEventType = 'HIRED' | 'PROMOTED' | 'TRANSFERRED' | 'ROLE_CHANGED' | 'TERMINATED';
export type BoardMemberRole = 'owner' | 'editor' | 'viewer';
export type NotificationType = 'TASK_ASSIGNED' | 'TASK_DEADLINE_APPROACHING' | 'MESSAGE_RECEIVED' | 'WORK_HISTORY_UPDATED';
